...
#ifndef ComboBoxListH
#define ComboBoxListH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
//---------------------------------------------------------------------------
class TComboBoxForm : public TForm
{
...
public:		// User declarations
	__fastcall TComboBoxForm(TComponent* Owner);
	int StartID;
	int START_ROW;
...
//---------------------------------------------------------------------------
extern PACKAGE TComboBoxForm *ComboBoxForm;
//---------------------------------------------------------------------------
#endif
